        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                ...
                <div style="background: #72b572; padding: 5px;border: 1px solid green;">
                    <a href="<?= Yii::$app->urlManager->createAbsoluteUrl(['ads/code/generate-code', 'aid' => $adsModel->id]); ?>" style="color:#fff;" id="link-pjax"><i class="fa fa-code"></i> دریافت کد</a>
                </div>
                ...
                ?>
                    <p>
                        ...
                        <a href="<?= Yii::$app->urlManager->createAbsoluteUrl(['ads/inout/my-inout', 'aid' => $adsModel->id]); ?>" id="link-pjax">نمایش</a>
                    </p>
                <?php 
                    }
                } ?>
